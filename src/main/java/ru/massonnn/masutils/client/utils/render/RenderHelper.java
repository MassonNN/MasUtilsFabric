...
import ru.massonnn.masutils.client.utils.render.primitive.PrimitiveCollectorImpl;
...
public class RenderHelper {
    ...
    public static void startExtraction(WorldExtractionContext context) {
        ...
        profiler.push("masutilsPrimitiveCollection");
