...
public class MineshaftCategory {
    ...
    public static ConfigCategory create(MasUtilsConfig defaults, MasUtilsConfig config) {
        ...
        categoryBuilder.groupIf(
                ...
                OptionGroup.createBuilder()
                        ...
                        .option(Option.<Boolean>createBuilder()
                                ...
                                .controller(ConfigUtils.createBooleanController())
                                .build())
                        // Profit Hint (только если Corpse Finder ВКЛ)
                        .optionIf(config.mineshaft.corpseFinder, Option.<Boolean>createBuilder()
                        ...
                        // Команды
                        .option(Option.<Boolean>createBuilder()
                                .name(Text.translatable("masutils.config.mineshaft.commands"))
                                .description(Text.translatable("masutils.config.mineshaft.commands.@Tooltip"))
                                .binding(defaults.mineshaft.mineshaftCommands,
                                        () -> config.mineshaft.mineshaftCommands,
                                        newValue -> config.mineshaft.mineshaftCommands = newValue)
                                .controller(ConfigUtils.createBooleanController())
                                .build())
                        .build()
        );

        categoryBuilder.optionIf(config.mineshaft.mineshaftFeaturesToggle, Option.<Boolean>createBuilder()
        ...
        categoryBuilder.groupIf(
                config.mineshaft.mineshaftFeaturesToggle && config.mineshaft.mineshaftParty.mineshaftPartyMode,
                OptionGroup.createBuilder()
                        ...
                        .option(Option.<Boolean>createBuilder()
                                ...
                                .description(Text.translatable("masutils.config.mineshaft.party.autotransfer.@Tooltip"))
                                .binding(defaults.mineshaft.mineshaftParty.autoTransferPartyOnMineshaft,
        ...
        categoryBuilder.groupIf(
                config.mineshaft.mineshaftFeaturesToggle && config.mineshaft.mineshaftESP.createWaypointToMineshaft,
                OptionGroup.createBuilder()
                        .name(Text.translatable("masutils.config.mineshaft.esp"))
                        .option(Option.<Color>createBuilder()
                                .name(Text.translatable("masutils.config.mineshaft.esp.color"))
                                .description(Text.translatable("masutils.config.mineshaft.esp.color.@Tooltip"))
                        ...
                        .option(Option.<Integer>createBuilder()
                                .name(Text.translatable("masutils.config.mineshaft.traceThickness"))
                                .description(Text.translatable("masutils.config.mineshaft.traceThickness.@Tooltip"))
                                ...
                                .controller(IntegerController.createBuilder().range(1, 10).build())
                                .build())
                        .build()
        );
